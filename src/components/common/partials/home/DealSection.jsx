        ...
        <div className="row justify-content-center">
            ...
            >
              <div className="banner banner-3 banner-fixed banner-radius content-middle overlay-zoom">
                ...
                <div className="banner-content">
                  <h3 className="banner-title text-white mb-1">For Men</h3>
          ...
          <div className="col-lg-4 mb-4 order-lg-auto order-sm-last">
            <Reveal keyframes={fadeIn} delay={200} duration={1000} triggerOnce>
              <div className="banner banner-4 banner-fixed banner-radius content-middle content-center overlay-zoom">
                <figure>
                  <LazyLoadImage
